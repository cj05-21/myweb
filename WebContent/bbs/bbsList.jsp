...
<div class="container">
	<table class="table table-hover">
  	<tr>   
	    <th style="width:300px" class="active">제목</th>
	    <th style="width:100px" class="active">작성자</th>
	    <th style="width:80px" class="active">조회수</th>
...
%>    
    	<a href="bbsRead.jsp?bbsno=<%=dto.getBbsno()%>&word=<%=word%>&col=<%=col%>&nowPage=<%=nowPage%>&subject=<%=dto.getSubject()%>&grpno=<%=dto.getGrpno()%>"><%=dto.getSubject() %></a>
<%     	
