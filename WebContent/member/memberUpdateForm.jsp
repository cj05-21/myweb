...
<form name="regForm"
      ...
      onsubmit="return memberUpdatCheck(this)" >
...
<tr>
	<th>*새 비밀번호</th>
	<td><input type="password" name="newpasswd" id="newpasswd" size="15" required></td>
</tr>
<tr>
	<th>*새 비밀번호 확인</th>
...
<tr>
	<th>전화번호</th>
	<td><input type="text" name="tel" id="tel" size="15" value="<%=dto.getTel()%>"></td>
</tr>
<tr>
	<th>우편번호</th>
	<td>
...
<tr>  
  <th>주소</th>
  <td><input type="text" name="address1" id="address1" size="30" value="<%=dto.getAddress1()%>" readonly></td>
</tr>
<tr>  
  <th>나머지주소</th>
  <td><input type="text" name="address2" id="address2" size="30" value="<%=dto.getAddress2()%>"></td>
</tr>
<tr>  
  <th>직업</th>
